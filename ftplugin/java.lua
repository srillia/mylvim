...
local launcher_path = vim.fn.glob(
  mason_home .. "/packages/jdtls/plugins/org.eclipse.equinox.launcher_*.jar"
)
...
local extra_bundles = vim.split(vim.fn.glob(mason_home .. "/packages/java-test/extension/server/*.jar"), "\n")
...
local config = {
  cmd = {
    ...
    launcher_path,
    "-configuration",
    mason_home .. "/packages/jdtls/config_" .. CONFIG,
    "-data",
    workspace_dir,
  },
